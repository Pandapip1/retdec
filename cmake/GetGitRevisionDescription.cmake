...
function(get_git_head_revision _refspecvar _hashvar)
	...
	if(EXISTS "${GIT_DIR}/commondir")
		file(READ "${GIT_DIR}/commondir" GIT_COMMON_DIR)
		string(STRIP "${GIT_COMMON_DIR}" GIT_COMMON_DIR)
		if(IS_ABSOLUTE "${GIT_COMMON_DIR}")
			set(GIT_DIR "${GIT_COMMON_DIR}")
		else()
			get_filename_component(GIT_DIR "${GIT_HEAD_DIR}/${GIT_COMMON_DIR}" ABSOLUTE)
		endif()
	endif()
